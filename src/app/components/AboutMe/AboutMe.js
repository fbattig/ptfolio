    ...
    <React.Fragment>
      ...
      >
        <div className="container m-auto">
          ...
          <h4 className="relative w-full font-[300] md:w-3/4 lg:w-2/3 xl:w-2/2 font-recoleta text-[#223740] text-2xl mb-10 px-1 md:px-24">
            Full Stack Development and Web Application Architecture
          </h4>
          <section className="relative flex flex-col lg:flex-row px-25 md:px-24">
            <p
              className={`w-full lg:w-1/3 text-[#223740] mr-0 mb-25  lg:mr-4 font-[200] ${hind.className}`}
            >
              {" "}
              With over a decade of experience as a Full Stack Developer and a 
              strong background in web development, Felix brings a comprehensive 
              skill set and in-depth knowledge of various technologies. Throughout 
              his career, Felix has worked on a wide range of projects, collaborating 
              with teams to enhance and maintain enterprise applications, automate
               processes, and improve database efficiency. His expertise includes C#, 
               .NET frameworks, SQL Server, Angular, and JavaScript, among others.
            </p>
            <p
            ...
            >
              ...
              and frameworks such as .NET, C#, ASP.NET, Angular, React.js, 
              Next.js and SQL Server. Through collaborative 
              teamwork, Felix has enhanced existing systems, automated processes, 
              and improved efficiency on SQL databases. Additionally, Felix has 
              experience in developing scalable web applications using modern
               web development tools and practices, including HTML, CSS, 
               JavaScript, and responsive design. With a solid understanding of 
               web application architecture and best practices, Felix has 
               consistently delivered high-quality solutions that meet client 
               equirements and contribute to the overall success of projects.
            </p>
            <p
              className={`w-full lg:w-1/3 text-[#223740] mr-0 mb-5  lg:mr-4 font-[200] ${hind.className}`}
            >
              {" "}
              Felix has a proven track record in developing scalable web applications, 
              utilizing agile methodologies to ensure effective collaboration and timely 
              project delivery. He is experienced in working with cloud-based platforms 
              such as Microsoft Azure, deploying and managing applications with efficiency.
              Additionally, Felix possesses strong problem-solving skills, enabling him
              to analyze client needs, identify requirements, and design robust 
              software solutions.
